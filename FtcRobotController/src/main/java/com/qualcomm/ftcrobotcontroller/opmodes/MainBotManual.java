...
public class MainBotManual extends OpMode {
    ...
    @Override public void loop() {
        ...
        //Digital controlled conglomerate
        if (gamepad1.left_bumper) { motorFL.   setPower(0.01); }
        if (gamepad1.right_bumper){ motorFR.   setPower(0.01); }
